...
This class of transformers are useful in some applications where the underlying training data exists uniformly on some higher dimensional manifold with particularly types of physical symmetries encoded by the algebra. This shows up in molecular force prediction, HEP top quark tagging, and robotics applications. The kernels are designed to be used as building blocks in larger models.
